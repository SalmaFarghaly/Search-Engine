...
//	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
//		String SearchInput = request.getParameter("SearchInput");
//		new getResponse(request,response,SearchInput).start();
//		}
//
//	
//
//	private class getResponse extends Thread{
//		String SearchInput;
//		HttpServletResponse response;
//		HttpServletRequest request;
//		public getResponse(HttpServletRequest request,HttpServletResponse response,String SearchInput) {
...
//		}
//		}
//		public  void AddingFirstHTMLPart(PrintWriter out,String SearchInput) {
//			// to edit the title
//			out.println("<!doctype html>\n" + "<html>\n" + "\n" + "<head>\n" + "    <title>" + SearchInput
//					+ " - Bing Search</title>\n"
//					+ "    <link rel=\"shortcut icon\" type=\"image/ico\" href=\"images/favicon.ico\" />\n"
...
//
//		}
//		public  void AddingPagebar(PrintWriter out,int PagesNum,String SearchInput) {
//			System.out.println("Done Adding document to html file");
//			out.println("<body>     \n" + 
//					"		<br>\n" + 
//					"		\n" + 
...
//		}
//		
//		public  void AddingResults(PrintWriter out,List<String> output,String SearchInput) {
//			int PageList = 0;
//			String names[] = SearchInput.split(" ");
//			String CapitalizedInput[] = new String[names.length];
//			for(int i=0;i<names.length; i++)
